...
AES1_Comm.o: C:/Projects/CryptoToolset/Libraries/AES1xxLibrary/AES1_Comm.c
	...
	avr-gcc -I"..\..\..\..\Libraries\AES1xxLibrary" -I"..\..\..\..\Libraries\includes" -I"..\..\..\Hardware\AVR_AT" -I"\WinAVR-20100110\avr\include" -Wall -g2 -gdwarf-2 -O1 -fpack-struct -fshort-enums -std=gnu99 -funsigned-char -funsigned-bitfields -mmcu=at90usb1287 -DF_CPU=16000000UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -c -o"$@" "$<"
