...
spi_phys.o: C:/Projects/CryptoToolset/LibraryExamples/Hardware/AVR_AT/spi_phys.c
	...
	avr-gcc -I"..\..\..\..\Libraries\AES1xxLibrary" -I"..\..\..\..\Libraries\utilities" -I"..\..\..\Hardware\Utilities" -I"..\..\..\Hardware\AVR_AT" -I"\WinAVR-20100110\avr\include" -Wall -g2 -gdwarf-2 -Os -fpack-struct -fshort-enums -std=c99 -funsigned-char -funsigned-bitfields -mmcu=at90usb1287 -DF_CPU=16000000UL -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -c -o"$@" "$<"
