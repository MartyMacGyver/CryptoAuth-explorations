...
void i2c_send_ack(uint8_t ack) {
	I2C_SET_OUTPUT();
	if (ack)
		I2C_DATA_LOW() ; //Low data line indicates an ACK.
	else
		I2C_DATA_HIGH(); // High data line indicates a NACK.
...
/** \brief This function writes one byte on the bus.
*
 *  \param data - 1 byte to write
 *  \return ack or nack
*/
...
/** \brief This function implements the physical I2C interface.
