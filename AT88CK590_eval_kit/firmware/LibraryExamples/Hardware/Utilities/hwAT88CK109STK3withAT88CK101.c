...
#ifdef AT88CK427 					  //RHINO-GREEN -1287
	#define LED1               _BV(3) //BLUE LED
	#define LED2               _BV(4) //RED LED
 ...
 *
 * \param[in] number number to display. Only three least significant bits are used.
 */
 ...
 *
 * \param[in] failure if 0 indicate success
 * \param[in] mode if failure blink with this pattern
 * \param[in] duration blink that many seconds and return. If 0 do not return.
 */
