...
copy %src_folder%\sha204_example_main.c %dest_folder%\*
...
copy %src_folder%\sha204_swi.* %dest_folder%\* 
copy %src_folder%\sha204_i2c.* %dest_folder%\* 
...
copy %src_folder%\delay_x.h %dest_folder%\*
